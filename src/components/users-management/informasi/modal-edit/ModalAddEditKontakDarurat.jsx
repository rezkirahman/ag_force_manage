...
const ModalAddEditKontakDarurat = ({ open, setOpen, refresh, title, family, edit = false }) => {
    ...
    const handleSuggestRelationship = useCallback(async () => {
        ...
        if (data?.data) {
            setSuggestRelationshipFamily(data?.data?.relation_emergency)
        }
    }, [unitKerja])
...
export default ModalAddEditKontakDarurat
