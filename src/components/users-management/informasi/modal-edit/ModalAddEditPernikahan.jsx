...
import { createProfilingData, suggestRelationship, updateProfilingKeluarga } from "@/api/users-management/profiling"


const ModalAddEditPernikahan = ({ open, setOpen, refresh, title, family, edit = false }) => {
    ...
    const handleSuggestRelationship = useCallback(async () => {
        ...
        if (data?.data) {
            setSuggestRelationshipFamily(data?.data?.relation_mariage)
        }
    }, [unitKerja])
    ...
    const handleAdd = useCallback(async () => {
        ...
        const { data } = await createProfilingData({
            type: toLower(title),
    ...
    }, [alamatDomisili, alamatKTP, alive, birthDate, birthPlace, lastEducation, name, params.id, phone, photo, postalCodeDomisiliId, postalCodeKTPId, refresh, selectedRelationship, setOpen, setOpenSnackbar, title, unitKerja, work])
    ...
    const handleClick = useCallback(async () => {
        ...
        setLoadingUpdate(false)
    }, [alamatDomisili, alamatKTP, alive, birthDate, birthPlace, edit, family?.id, lastEducation, name, params.id, phone, photo, postalCodeDomisiliId, postalCodeKTPId, refresh, selectedRelationship, setOpen, setOpenSnackbar, unitKerja, work])
...
export default ModalAddEditPernikahan
