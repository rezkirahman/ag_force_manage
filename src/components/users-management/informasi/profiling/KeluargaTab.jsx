...
import ModalAddEditKeluarga from '../modal-edit/ModalAddEditKeluarga'
...
const KeluargaTab = ({ MenuButton, title }) => {
    ...
    const handleData = useCallback(async () => {
        ...
        if (data?.data) {
            const family = data.data?.filter((family) => ['ayah', 'ibu', 'adik', 'kakak'].includes(family?.relationship.toLowerCase()));
            setData(family)
        }
    }, [params, unitKerja])
