...
import ModalAddEditPernikahan from '../modal-edit/ModalAddEditPernikahan'
import { capitalizeFirstLetter } from '@/helper/capitalFirst'

const PernikahanTab = ({ MenuButton, title }) => {
    ...
    const handleData = useCallback(async () => {
        ...
        if (data?.data) {
            const family = data.data?.filter((family) => ['pasangan', 'anak'].includes(family?.relationship.toLowerCase()));
            setData(family)
        }
    }, [params, unitKerja])
