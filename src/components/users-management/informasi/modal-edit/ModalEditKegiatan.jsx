...
const optionTypeKegiatan = [
    { item: 'Konservasi Hutan', value: 'konservasi hutan' },
    { item: 'Konservasi Flora', value: 'konservasi flora' },
    { item: 'Konservasi Fauna', value: 'konservasi fauna' },
    { item: 'Konservasi Laut', value: 'konservasi laut' },
    { item: 'Korporasi Hijau', value: 'korporasi hijau' },
    { item: 'PRB', value: 'PRB' },
    { item: 'Tanggap Darurat', value: 'tanggap darurat' },
    { item: 'Paska Bencana', value: 'paska bencana' },
    { item: 'Pendidikan', value: 'pendidikan' },
    { item: 'Kesehatan', value: 'kesehatan' },
    { item: 'Olahraga', value: 'olahraga' },
    { item: 'Seni Budaya', value: 'seni budaya' },
    { item: 'Kepedulian Anak', value: 'kepedulian anak' },
    { item: 'Kepedulian Duka', value: 'kepedulian duka' },
    { item: 'Kepedulian Pangan', value: 'kepedulian pangan' },
    { item: 'Lapangan Kerja', value: 'lapangan kerja' },
    { item: 'Keahlian dan Ketrampilan', value: 'keahlian dan ketrampilan' },
    { item: 'UMKM', value: 'UMKM' },
    { item: 'Kemitraan', value: 'kemitraan' },
    { item: 'Litigasi', value: 'litigasi' },
    { item: 'Non Litigasi', value: 'non litigasi' },
    { item: 'Mitigasi', value: 'mitigasi' },
    { item: 'Hak Cipta', value: 'hak cipta' },
    { item: 'Corcom', value: 'corcom' },
    { item: 'Lainya', value: 'lainnya' },
]

const ModalEditKegiatan = ({ open, setOpen, refresh, title, data }) => {
        ...
        >
            <div className="space-y-4">
                <div className="sticky z-10 flex items-start justify-between bg-white -top-2">
                    <h3 className="font-semibold">Riwayat Kegiatan</h3>
                    <Button
                        onClick={() => {
                            handleAddKegiatan()
                            setTimeout(() => {
                    ...
                    {items?.map((data, index) => (
                        <div key={index} className="p-4 space-y-2 rounded-xl ring-2 ring-inset ring-gray-200">
                            <div className="flex items-center justify-between">
                                <h3 className="font-medium">Kegiatan {index + 1}</h3>
                            ...
                            <div className="space-y-3">
                                ...
                                <FormControl fullWidth>
                                    ...
                                    <Select
                                        ...
                                        label="Jenis"
                                    >
                                        {optionTypeKegiatan.map((data, index) => (
                                            <MenuItem key={index} value={data.value}>{data.item}</MenuItem>
                                        ))}
                                    </Select>
                                </FormControl>
                                <FormControl fullWidth>
                                    <InputLabel>Kegiatan AGP</InputLabel>
                                    <Select
                                        value={data.is_agp}
                                        onChange={(e) => handleItemChange(index, "is_agp", e.target.value)}
                                        label="Kegiatan AGP"
                                    >
